    ...
    <article id="vereinsmeldung-teams">
        ...
        <div>
            <div class="">
                <div>
                    Dein Verein:
                    <div class="fw-bold"><?= $user->verein->name ?></div>
                </div>
            </div>
            <hr/>
            ...
            <ul class="list-group link-group" id="contactlist">
                <li class="list-group-item list-group-item-secondary list-group-item-action border border-1 border-secondary p-1 my-1 mx-0">
                    <div class="card-body p-2">
                        ...
                        <a href="<?= Url::toRoute(['vereinsmeldung/add-team-altersbereich','p'=>$vereinsmeldung->id]) ?>" class="stretched-link" id="item-new-link"></a>
                    </div>
                </li>
        ...
        <div class="d-flex justify-content-between p-1">
            <div class="d-flex justify-content-between p-1">
                <div class="form-group">
                    <a href="<?= Url::toRoute(['vereinsmeldung/index']) ?>" class="btn btn-primary">Zurück zur Übersicht</a>
                </div>
            </div>
            <?php if(count($teams)==0){ ?>
            <div>
                <a href="<?= Url::toRoute(['vereinsmeldung/no-teams','p'=>$vereinsmeldung->id]) ?>" class="btn btn-danger" id="finish-with-empty-teams">Ohne Mannschaft abschließen</a>
            </div>
            <?php } ?>
        </div>
