            ...
            <?php $form = ActiveForm::begin(FormHelper::getConfigArray());?>
                ...
                <div class="d-flex justify-content-between p-1">
                    <div class="form-group">
                        <a href="<?= Url::toRoute(['vereinsmeldungadmin/vereinsmeldung-verein','p'=>$vereinsmeldungTeams->vereinsmeldung_id]) ?>" class="btn btn-outline-secondary">Abbrechen</a>
                        <?= Html::submitButton('Speichern', ['class' => 'btn btn-primary']) ?>
                    </div>
                    <div>
                        <a href="<?= Url::toRoute(['vereinsmeldungadmin/delete-team','p'=>$team->id]) ?>" class="btn btn-danger">Löschen</a>
                    </div>
                </div>
