...
function replace_url_for_vereinsmeldungadmin($route){
    return str_replace('vereinsmeldung', 'vereinsmeldungadmin', $route);
}
...
?>
                ...
                <li class="list-group-item list-group-item-action border border-1 border-secondary p-1 m-1 <?= ($item->isDone($vereinsmeldung))?'bg-light opacity-50':'' ?>">
                    <div class="card-body" id="vereinsmeldemodul-<?= $item->id ?>">
                        ...
                        <a href="<?= Url::toRoute([replace_url_for_vereinsmeldungadmin($item->url), 'p'=>$vereinsmeldung->id]) ?>" class="stretched-link"></a>
                    </div>
                </li>
